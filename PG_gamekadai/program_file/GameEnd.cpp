...
void GameEnd::Draw() const
{
	...
	DrawString(450, 200 + endy, "　　  「いろあい」 ", 0xFFFFFF);
	DrawString(450, 230 + endy, "         制作者    ", 0xFFFFFF);
	DrawString(450, 260 + endy, "☆2-4　崎間　　竜也", 0xFFFFFF);
	DrawString(450, 290 + endy, "　2-4　佐久本　盛杏", 0xFFFFFF);
	DrawString(450, 320 + endy, "　2-3　與那原　廉  ", 0xFFFFFF);
